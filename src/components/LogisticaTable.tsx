    ...
    const allColumns = [
      ...(showSourceSelection
        ? [
            {
              label: 'FONTE',
              width: 'min-w-[50px] w-[50px] text-center',
      ...
      {
        label: 'C',
        width: 'min-w-[40px] w-[40px] text-center',
        field: 'concluido',
        tooltip: 'Concluído',
      },
      {
        label: 'Data Concluído',
        width: 'min-w-[150px] w-[150px]',
        field: 'data_concluido',
      },
      {
        label: 'S',
        width: 'min-w-[40px] w-[40px] text-center',
      ...
      {
        label: 'Ações',
        width: 'min-w-[120px] w-[120px] text-center',
        field: 'acoes',
      },
    ]
      ...
      <TableHeader className="bg-[var(--orange)]">
        <TableRow>
          {columns.map((col) => (
            <TableHead
              key={col.field}
              className={`${col.width} cursor-pointer py-2 text-xs font-bold uppercase select-none ${
